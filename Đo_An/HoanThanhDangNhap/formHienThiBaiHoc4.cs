...
{
    public partial class formHienThiBaiHoc4 : Form
    {
        ...
        int nActi = int.Parse(formDiToiBaiHoc4.SoActi);
        int nQT = formDiToiBaiHoc4.TiendoActi;
        ...
        private void HienThiBaiHoc(int v)
        {
            ...
            string chuong = formDiToiBaiHoc4.sttChuongBaiHoc4;
